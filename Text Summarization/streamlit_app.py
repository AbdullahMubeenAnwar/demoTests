...
st.set_page_config(
    layout="wide", page_title="Text Summarization", page_icon="Text Summarization/images/jsl_logo_icon.png", initial_sidebar_state="auto"
)
...
logo = st.sidebar.image("Text Summarization/images/logo.png", width=300)
...
if custom_input:
    output = fit_data(Pipeline, custom_input)
    st.write(output)
elif model == "t5_base":
